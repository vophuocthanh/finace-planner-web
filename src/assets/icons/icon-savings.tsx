  ...
  return (
    <svg width={width} height={height} viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
      <path
        ...
        stroke-width='1.5'
      />
      <path d='M15 2.5V6C15 7.10457 15.8954 8 17 8H19.5' stroke={color} stroke-width='1.5' stroke-linecap='round' />
      <path d='M8 12H16' stroke={color} stroke-width='1.5' stroke-linecap='round' />
      <path d='M8 17H12' stroke={color} stroke-width='1.5' stroke-linecap='round' />
    </svg>
  )
}
